...
def odeint(func, diffusion_func, y0, t, *, rtol=1e-7, atol=1e-9, method=None, options=None, event_fn=None, diffusion_mode = "only_t0"):
    ...
    solver = SOLVERS[method](func = func, diffusion_func = diffusion_func, y0=y0, rtol=rtol, atol=atol, diffusion_mode = diffusion_mode, **options)
